						...
						<div class="col-lg">
							<div class="p-5">
								<div class="text-center">
									<img src="<?= base_url('assets/img/user/admin2.png') ?>"
								...
								<div class="text-center">
									...
									<a href="<?= base_url('beranda');?>" data-toggle="tooltip" data-placement="bottom"
										title="Kembali ke Beranda"><i class="fas fa-arrow-circle-left"></i></a>
								</div>
							</div>
						</div>
					</div>
