			...
			<div class="card shadow mb-4 col-lg-12">
				<div class="card-header">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md">
								<form action="<?= base_url('pelayanan/kredit/') . $anggota['anggota']['id_anggota'] ?>" method="POST" enctype="multipart/form-data">
									<div class="form-group">
										<label for="no_buku">No Buku : </label>
										<input type="text" class="form-control" name="no_buku" id="no_buku" readonly value="<?= $anggota['anggota']['no_buku']; ?>">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" name="pekerjaan" id="pekerjaan" class="form-control" value="<?= $anggota['anggota']['pekerjaan'] ?>" readonly>
									</div>
									<div class="form-group">
										<label for="penghasilan">Penghasilan :</label>
										<input type="text" name="penghasilan" class="form-control" placeholder="Masukan Penghasilan">
										<?= form_error('penghasilan', '<small class="text-danger">', '</small>'); ?>
									</div>
									<div class="form-group">
										<label for="pinjaman">Pinjaman :</label>
										<input type="text" name="pinjaman" class="form-control" placeholder="Masukan Pinjaman">
							...
							<div class="col-md">
								...
								<div class="form-group">
									...
									<input type="text" name="simpanan" id="simpanan" class="form-control" value="<?= $t_simpanan['saldo'] ?>" readonly>
								</div>
								<div class="form-group">
