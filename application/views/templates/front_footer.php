    ...
    <footer id="footer">
    			...
    			<div class="row">
    				...
    				<div class="col-lg-3 col-md-6 footer-info text-justify">
    					...
    					<p>
    						...
    						di seluruh pelosok provinsi NTT yang tercakup dalam 3 wilayah, yaitu Wilayah Timor,
    						Flores, dan Sumba. Pelayanan keuangan yang disediakan sesuai dengan kebutuhan para
    						anggota dan disampaikan secara profesional oleh para staf terdidik dan berkomitmen tinggi
    						terhadap kemajuan komunitas.
    				</div>
    				...
    				<div class="col-lg-3 col-md-6 footer-contact text-justify">
    					<h4>Kontak</h4>
    					<p>
    						<strong>Alamat : </strong>
    						Jl. Perintis Kemerdekaan,
    						Klp. Lima, Kota Kupang,
    						Nusa Tenggara Tim. 85228<br>
    						<strong>Telepon : </strong> (0380) 829790<br>
    						<strong>Email : </strong> kopdit_swastisari@yahoo.com<br>
    					</p>
    				...
    				<div class="col-lg-3 col-md-6 footer-newsletter">
    					<h4>Jam Buka</h4>
    					<p><strong>Rabu :</strong> 08.00–17.00 <br>
    						<strong>Kamis :</strong> 08.00–17.00<br>
    						<strong>(Iduladha) :</strong> Jam buka dapat berbeda <br>
    						<strong>Jumat) :</strong> 08.00–17.00 <br>
    						<strong>(Iduladha) :</strong> Jam buka dapat berbeda <br>
    						<strong>Sabtu :</strong> Tutup<br>
    						<strong>Minggu :</strong> Tutup<br>
    						<strong>Senin :</strong> 08.00–17.00<br>
    						<strong>Selasa :</strong> 08.00–17.00<br>
    					</p>
    	...
    	<div class="container">
    		<div class="copyright">
    			&copy; Copyright <strong><span>Kopdit Swastisari</span></strong> <?= date('Y'); ?>
    		</div>
    		<div class="credits">
