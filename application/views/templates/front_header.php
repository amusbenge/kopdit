...
<head>
	...
	<link href="<?= base_url() ?>assets/frontend/assets/vendor/line-awesome/css/line-awesome.min.css" rel="stylesheet">
	...
	<!-- Template css user -->
	<link href="<?= base_url() ?>assets/frontend/assets/css/frontend-style.css" rel="stylesheet">

	<!-- lightbox -->
	<script type="text/javascript" src="<?= base_url() ?>assets/frontend/assets/js/jquery.lightbox-0.5.js"></script>
	<link href="<?= base_url() ?>assets/frontend/assets/css/jquery.lightbox-0.5.css" rel="stylesheet">

	<link href="<?= base_url() ?>assets/frontend/assets/css/table.css" rel="stylesheet">
	<link href=" <?= base_url() ?>assets/frontend/assets/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
