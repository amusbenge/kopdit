	...
	<div class="card shadow mb-4">
		<div class="card-header d-flex justify-content-between">
			...
			<div class="col-lg-3">
				...
				<?php if ($user['role_id'] == 1) : ?>
					<a href="#" class="btn btn-danger btn-icon-split btn-sm" id="btn-delete">
						<span class="icon text-white-50">
		...
		<div class="card-body">
			<div class="table-responsive">
				<form method="post" action="<?php echo base_url('admin/anggota/hapus') ?>" id="form-delete">
					<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
						...
						<tbody>
							...
							<?php foreach ($anggota as $agt) : ?>
								<tr>
									<td><input type='checkbox' class='check-item' name='id_anggota[]' value='<?= $agt['id_anggota']; ?>'></td>
									<th scope="row"><?= $i; ?></th>
									<td><?= $agt['no_buku'] ?></td>
