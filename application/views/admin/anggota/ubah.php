    ...
    <div class="container-fluid">
    	...
    	<div class="card shadow mb-2 col-lg-12">
    		<div class="card-body">
    			<form class="row" action="<?= base_url('admin/anggota/ubah/') . $anggota['id_anggota'];?>"
    				method="POST">
    				<div class="col-md-6">
    						...
    						<div class="col-sm-9 ">
    							<select class="custom-select" name="jns_kelamin">
    								...
    								<option value="Perempuan"
    									<?= $anggota['jns_kelamin'] == 'Perempuan' ? 'Selected' : '' ?>>Perempuan
    								</option>
    							</select>
    						</div>
    					</div>
    						...
    						<div class="col-sm-9">
    							<select class="custom-select" name="pendidikan_terakhir" id="pendidikan_terakhir">
    								...
    								<option value="Sarjana"
    									<?= $anggota['pendidikan_terakhir'] == 'Sarjana' ? 'Selected' : '' ?>>
    									Sarjana</option>
    								<option value="SMA/SMK"
    									<?= $anggota['pendidikan_terakhir'] == 'SMA/SMK' ? 'Selected' : '' ?>>
    									SMA/SMK</option>
    								<option value="SMP"
    									<?= $anggota['pendidikan_terakhir'] == 'SMP' ? 'Selected' : '' ?>>SMP
    								</option>
    								<option value="SD" <?= $anggota['pendidikan_terakhir'] == 'SD' ? 'Selected' : '' ?>>
    									SD</option>
    								<option value="Tidak bersekolah"
    									<?= $anggota['pendidikan_terakhir'] == 'Tidak bersekolah' ? 'Selected' : '' ?>>
    					...
    					<div class="form-group row mt-3 ">
    						...
    						<div class="col-sm-9">
    							<select class="custom-select" name="pekerjaan" id="pekerjaan">
    								...
    								<option value="<?= $pek['nm_sub_kriteria'] ?>"
    									<?= $pek['nm_sub_kriteria'] == $anggota['pekerjaan'] ? 'Selected' : '' ?>>
