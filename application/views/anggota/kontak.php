    ...
    <section id="breadcrumbs" class="breadcrumbs">
        ...
        <div class="container">
            <ol>
                ...
                <li><a href="<?= base_url('anggota/kontak') ?>"></a> Kontak</li>
            </ol>
        </div>
        ...
        <div class="container">
            <div class="row mt-5">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0" data-aos="fade-left">
                    ...
                    <form action="<?= base_url('anggota/kirimEmail'); ?>" method="post">
                        <div class="form-row">
                            ...
                            <?php else : ?>
                                <div class="col-md-6 form-group">
                                    <input type="text" name="name" class="form-control" id="name" value="<?= $anggota['anggota']['nm_anggota']; ?>" readonly />
                                </div>
                                <div class="col-md-6 form-group">
                                    <input type="email" class="form-control" name="email" id="email" value="<?= $anggota['anggota']['email']; ?>" readonly />
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <div class="col-lg-5 mt-5 mt-lg-0" data-aos="fade-left">
                    <div>
                        <iframe style="border:0; width: 100%; height: 270px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d981.8367314891464!2d123.62051138427822!3d-10.152429326088065!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2c56833458da4751%3A0x798e9aa8d3b924c2!2sKopdit%20Swastisari!5e0!3m2!1sid!2sid!4v1596032705519!5m2!1sid!2sid" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
