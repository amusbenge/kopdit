<main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        ...
        <div class="container">
            <ol>
                <li><a href="<?= base_url('anggota/artikel') ?>"></i> Artikel</a></li>
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-meta">
                            <ul>
                                ...
                                <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="#"><time datetime="<?= $artikel['tanggal_buat']; ?>"><?= $artikel['tanggal_buat']; ?></time></a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <?php if ($p <= 4) : ?>
                                <div class="sidebar-item recent-posts">
                                    <div class="post-item clearfix">
                                        ...
                                        <h4><a href="<?= base_url('anggota/detailArtikel/') . $art['id_artikel']; ?>"><?= $art['judul']; ?></a>
                                        </h4>
